...
# gha-load-config — Additional Context
...
GHA composite action: load and parse `.github/repository-config.yml`.
...
| Path | Purpose |
|------|---------|
| `src/` | Python source for the action logic |
| `action.yml` | Composite action definition |
| `test-project/` | Test fixtures for the action |
